...
You agree with the proposed action. It runs as-is (for example, the prepared reply is
sent). The run moves to **Executed**.
...
You decline. Add a short **note** explaining why, so the reason is on the record. Nothing
is sent; the run moves to **Rejected**.

## Why the gate matters

Until you act, no reply goes out and nothing irreversible happens. That pause is the whole
point of the tool: the agent removes the busywork, you keep the judgment.
