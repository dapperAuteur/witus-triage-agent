...
The **queue** (`/triage`) is your to-do list: every message waiting on your decision.
Each row shows where the message came from, what the agent thinks it is, and a status
badge.
...
Finished items (executed, rejected, failed) move out of the queue and into
**[History](/triage/history)** (`/triage/history`), newest first. Use it to look back at
